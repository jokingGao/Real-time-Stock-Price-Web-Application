...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Email Notification</h1>
			</div>
		</div><!--/.row-->
            ...
            <div class="panel panel-default">
				<div class="panel-heading">Your notification</div>
					<div class="panel-body">
							<form role="form">
							 <?php
                                $query = mysql_query("SELECT stockname, stopprice FROM user_email WHERE username = '$username'");
                                while ($row=mysql_fetch_row($query))
                                    {
                                        $sub="submit";
                                        echo "You have select ". $row[0].", stop loss price is ".$row[1],".</br>";
                                    }
                            ...
                            {	
                                ...
                                if (isset($_POST["email_stock"]) and isset($_POST["email_price"])){
                                    ...
                                    $query = mysql_query("SELECT email FROM users where username = '$username'");
                                    $email = mysql_result($query,0);
                                    $query = mysql_query("INSERT INTO user_email VALUES('$username','$email','$email_stock','$email_price')");
                                }
